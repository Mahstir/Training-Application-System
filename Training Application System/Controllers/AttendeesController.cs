...
namespace Training_Application_System.Controllers
{
    public class AttendeesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,FirstName,LastName")] Attendee attendee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,FirstName,LastName")] Attendee attendee)
        {
            if (ModelState.IsValid)
            {
